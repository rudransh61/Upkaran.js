...
// index.js
var _upkaranJs = require("./Upkaran.js");
var _appJs = require("./App.js");
var _routeJs = require("./Route.js"); // Import the route handling function
...
const state = (0, _stateJs.createState)(initialState);
// Define components
const Increment = ()=>{
    state.setState({
...
var _renderCountJs = require("./RenderCount.js");
function ListComponent(num) {
    // Function to render the list items
    const renderListItems = ()=>{
        const comp = [];
        for(let i = 0; i < num; i++)comp.push((0, _renderCountJs.renderListItem)());
        return comp;
    };
    return {
        type: "ul",
...
},{"./RenderCount.js":"axEqH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"axEqH":[function(require,module,exports) {
// RenderCount.js
// Define a component to render the count dynamically
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderListItem", ()=>renderListItem);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequirec289")
